...
use CustomerFamily\Model\Thelia\Model\BrandQuery;
use CustomerFamily\Model\Thelia\Model\Brand as ChildBrand;
...
abstract class CustomerFamilyAvailableBrand implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerFamily\\Model\\Map\\CustomerFamilyAvailableBrandTableMap';
    ...
    /**
     * Initializes internal state of CustomerFamily\Model\Base\CustomerFamilyAvailableBrand object.
     */
    ...
    /**
     * Compares this with another <code>CustomerFamilyAvailableBrand</code> instance.  If
     * <code>obj</code> is an instance of <code>CustomerFamilyAvailableBrand</code>, delegates to
     * <code>equals(CustomerFamilyAvailableBrand)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CustomerFamilyAvailableBrand The current object, for fluid interface
     */
     ...
     * @return   \CustomerFamily\Model\CustomerFamilyAvailableBrand The current object (for fluent API support)
     */
    public function setCustomerFamilyId($v)
    {
        ...
        if ($this->customer_family_id !== $v) {
            ...
            $this->modifiedColumns[CustomerFamilyAvailableBrandTableMap::CUSTOMER_FAMILY_ID] = true;
        }
    ...
    public function setBrandId($v)
    {
        ...
        if ($this->brand_id !== $v) {
            $this->brand_id = $v;
            $this->modifiedColumns[CustomerFamilyAvailableBrandTableMap::BRAND_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CustomerFamilyAvailableBrandTableMap::translateFieldName('CustomerFamilyId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_family_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CustomerFamilyAvailableBrandTableMap::translateFieldName('BrandId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CustomerFamilyAvailableBrandTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \CustomerFamily\Model\CustomerFamilyAvailableBrand object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCustomerFamilyAvailableBrandQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CustomerFamilyAvailableBrand::setDeleted()
     * @see CustomerFamilyAvailableBrand::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCustomerFamilyAvailableBrandQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CustomerFamilyAvailableBrandTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CustomerFamilyAvailableBrandTableMap::CUSTOMER_FAMILY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CUSTOMER_FAMILY_ID';
        }
        if ($this->isColumnModified(CustomerFamilyAvailableBrandTableMap::BRAND_ID)) {
            $modifiedColumns[':p' . $index++]  = 'BRAND_ID';
        }

        $sql = sprintf(
            'INSERT INTO customer_family_available_brand (%s) VALUES (%s)',
    ...
    {
        $pos = CustomerFamilyAvailableBrandTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CustomerFamilyAvailableBrand'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CustomerFamilyAvailableBrand'][serialize($this->getPrimaryKey())] = true;
        $keys = CustomerFamilyAvailableBrandTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CustomerFamilyAvailableBrandTableMap::CUSTOMER_FAMILY_ID)) $criteria->add(CustomerFamilyAvailableBrandTableMap::CUSTOMER_FAMILY_ID, $this->customer_family_id);
        if ($this->isColumnModified(CustomerFamilyAvailableBrandTableMap::BRAND_ID)) $criteria->add(CustomerFamilyAvailableBrandTableMap::BRAND_ID, $this->brand_id);
    ...
    {
        $criteria = new Criteria(CustomerFamilyAvailableBrandTableMap::DATABASE_NAME);
        $criteria->add(CustomerFamilyAvailableBrandTableMap::CUSTOMER_FAMILY_ID, $this->customer_family_id);
        $criteria->add(CustomerFamilyAvailableBrandTableMap::BRAND_ID, $this->brand_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCustomerFamilyId()) && (null === $this->getBrandId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomerFamily\Model\CustomerFamilyAvailableBrand (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerFamily\Model\CustomerFamilyAvailableBrand Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCustomerFamily(ChildCustomerFamily $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCustomerFamilyAvailableBrand($this);
        }
    ...
    public function getCustomerFamily(ConnectionInterface $con = null)
    {
        if ($this->aCustomerFamily === null && ($this->customer_family_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCustomerFamily->addCustomerFamilyAvailableBrands($this);
             */
        }
    ...
    public function getBrand(ConnectionInterface $con = null)
    {
        if ($this->aBrand === null && ($this->brand_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBrand->addCustomerFamilyAvailableBrands($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CustomerFamilyAvailableBrandTableMap::DEFAULT_STRING_FORMAT);
    }
