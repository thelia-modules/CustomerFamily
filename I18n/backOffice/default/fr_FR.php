...
return array(
    ...
    'Equation: [ ( ( product_purchase_price + fix_amount_1 ) x factor ) + fix_amount_2 ] x taxes' => 'Equation : [ ( ( prix_d_achat + montant_fixe_1 ) x facteur ) + montant_fixe_2 ] x taxes',
    'Factor' => 'Facteur',
    'Families' => 'Familles',
    ...
    'Not using the equation will display the fix product price to customers.' => 'Ne pas utiliser l\'équation affichera le prix fixe des produits aux clients.',
