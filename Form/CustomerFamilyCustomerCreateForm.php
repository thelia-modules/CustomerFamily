...
/**
 * Class CustomerFamilyCustomerCreateForm
 * @package CustomerFamily\Form
 */
class CustomerFamilyCustomerCreateForm extends CustomerCreateForm
{
    /**
    ...
    {
        return 'customer_family_customer_create_form';
    }
    ...
    public function checkProfessionalInformations($value, ExecutionContextInterface $context)
    {
        ...
        if (null != $form = $this->getRequest()->request->get("customer_family_customer_create_form")) {
