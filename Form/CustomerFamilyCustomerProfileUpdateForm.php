...
/**
 * Class CustomerFamilyCustomerProfileUpdateForm
 * @package CustomerFamily\Form
 */
class CustomerFamilyCustomerProfileUpdateForm extends CustomerProfileUpdateForm
{
    /**
    ...
    {
        return 'customer_family_customer_profile_update_form';
    }
    ...
    public function checkProfessionalInformations($value, ExecutionContextInterface $context)
    {
        ...
        if (null != $form = $this->getRequest()->request->get("customer_family_customer_profile_update_form")) {
